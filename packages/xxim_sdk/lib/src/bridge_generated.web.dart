...
class XximSdkWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_init__static_method__XximSdk(NativePortType port_, String config_str);
}
...
class XximSdkWire extends FlutterRustBridgeWasmWireBase<XximSdkWasmModule> {
  ...
  void wire_init__static_method__XximSdk(NativePortType port_, String config_str) => wasmModule.wire_init__static_method__XximSdk(port_, config_str);
}
